...
import {DeletePartComponent} from 'src/app/pages/dialogs/partsWerehouse/delete-part/delete-part.component';
import {EditPartComponent} from 'src/app/pages/dialogs/partsWerehouse/edit-part/edit-part.component';
...
import {TakePartsComponent} from 'src/app/pages/dialogs/partsWerehouse/take-parts/take-parts.component';
import {animate, state, style, transition, trigger} from '@angular/animations';
//dialogs for  moves parts
import {RegisterIncomingComponent} from 'src/app/pages/dialogs/parts-warehouse/register-incoming/register-incoming.component';
import {AddEditPartComponent} from 'src/app/pages/dialogs/partsWerehouse/add-edit-part/add-edit-part.component';

import {UploadFileComponent} from 'src/app/pages/dialogs/partsWerehouse/upload-file/upload-file.component';
import {ShowErrorsComponent} from 'src/app/pages/dialogs/partsWerehouse/show-errors/show-errors.component';
